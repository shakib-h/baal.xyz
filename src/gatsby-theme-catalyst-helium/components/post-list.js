...
import {
    useCatalystBlogConfig
} from "gatsby-theme-catalyst-blog"
import {
    useHeliumConfig
} from "gatsby-theme-catalyst-helium"
...
const PostsList = ({
        ...
        return ( <
            Layout >
            <
            SEO title = "বালছাল বিষয়ে নিত্য নতুন পোস্ট" / > {
                useHero && < Hero / >
            } <
            div sx = {
                {
            ...
            } >
            {
                posts.map((post, index) => {
                        ...
                        return ( <
                            ...
                            div >
                            <
                            Styled.ul aria - label = "Categories"
                            sx = {
                                {
                                    listStyle: "none",
                                    m: 0,
